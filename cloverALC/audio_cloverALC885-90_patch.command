...
# File: audio_cloverALC885-90_patch.sh_v1.0
...
# 2. Verify Downloads/audio_ALC885-master present
# 3. cloverALC/audio_cloverALC885-90-patch
#    1. Verify Clover/config.plist/Devices/Audio/Inject/(Audio ID: 1, 2 or 3)
#    2. Verify Clover/config.plist/KernelAndKextPatches/KextsToPatch/AppleHDA/ALC885 (opt)
...
#
# Installation
# 1. Downloads/audio_ALC885-master/cloverALC/audio_cloverALC885-90_patch.command
# 2. Double click audio_cloverALC885-90_patch.command (Do not move folder or file)
# 3. Enter password at prompt
# 4. Restart
#
echo " "
echo "Agreement"
echo "The audio_cloverALC885-90_patch is for personal use only. Do not" 
...
echo "audio_cloverALC885-90_patch is provided as is and without any warranty."
echo " "
...
cd Downloads/audio_ALC885-master 
unzip -q 885.zip
cd 885
